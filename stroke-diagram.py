...
raw_path_strs = {
    'ra-katakana': [
        "M320,240 C393,240 665,241 731,236",
        "M226,425 C366,423 713,428 830,419 C791,586 670,832 311,866",
    ],
    'ri-katakana': [
        "M311,165 C315,241 313,473 311,583",
        "M649,129 C635,458 725,707 377,836",
    ],
    'ru-katakana': [
        "M357,234 C336,519 347,599 142,775",
        "M558,183 C562,723 565,757 521,764 C676,709 809,556 868,439",
    ],
    're-katakana': [
        "M384,147 C380,578 402,734 354,741 C601,691 793,521 839,382",
    ],
    'ro-katakana': [
        "M266,263 C270,378 263,674 259,773",
        "M266,263 C361,259 702,259 791,261 C788,336 788,691 793,771",
        "M266,697 C391,693 670,697 791,691",
    ],
}
