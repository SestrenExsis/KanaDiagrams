...
raw_path_strs = {
    'nu-hiragana': [
        "M188,298 C190,355 332,674 444,779",
        "M546,218 C487,604 354,891 222,812 C96,736 197,286 638,364 C932,467 825,766 667,836 C519,887 507,661 645,684 C717,695 809,750 873,820",
    ],
}
