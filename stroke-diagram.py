...
raw_path_strs = {
    'ka-katakana': [
        "M117,394 C268,387 590,382 717,364 C649,453 788,985 501,798",
        "M418,165 C437,473 354,683 156,864",
    ],
    'ki-katakana': [
        "M218,391 C318,375 667,323 759,302",
        "M190,645 C282,635 740,560 862,547",
        "M451,179 C471,286 592,811 613,900",
    ],
    'ku-katakana': [
        "M464,184 C430,339 345,483 233,556",
        "M425,309 C469,311 720,316 765,309 C729,334 731,691 265,852",
    ],
    'ke-katakana': [
        "M398,145 C370,300 298,467 160,578",
        "M339,345 C396,341 786,350 841,350",
        "M613,348 C624,624 491,773 295,818",
    ],
    'ko-katakana': [
        "M186,286 C250,288 651,288 720,288 C718,366 722,715 722,775",
        "M185,700 C242,699 652,700 718,700",
    ],
}
