...
raw_path_strs = {
    'ha-katakana': [
            "M377,288 C343,450 243,603 138,706",
            "M617,266 C697,369 825,567 864,695",
    ],
    'hi-katakana': [
            "M281,458 C393,448 642,393 727,325",
            "M284,174 C286,869 186,747 805,750",
    ],
    'fu-katakana': [
            "M208,325 C364,330 702,321 788,316 C711,750 507,771 290,827",
    ],
    'he-katakana': [
            "M144,638 C633,323 179,291 880,754",
    ],
    'ho-katakana': [
            "M170,373 C302,375 679,371 885,371",
            "M524,167 C496,891 606,862 400,820",
            "M350,531 C327,588 245,716 185,771",
            "M697,521 C745,579 839,672 893,729",
    ],
}
