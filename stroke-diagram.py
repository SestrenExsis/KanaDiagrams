...
raw_path_strs = {
    'ta-katakana': [
        "M432,168 C400,318 275,474 190,546",
        "M389,302 C494,304 660,307 734,300 C676,407 688,706 229,850",
        "M373,467 C467,505 581,599 652,668",
    ],
    'chi-katakana': [
        "M708,217 C636,257 414,305 238,323",
        "M140,519 C295,517 766,519 880,522",
        "M530,321 C512,496 601,782 297,866",
    ],
    'tsu-katakana': [
        "M167,332 C211,371 266,448 295,505",
        "M363,259 C411,311 464,371 489,432",
        "M777,247 C720,517 668,704 315,862",
    ],
    'te-katakana': [
        "M297,297 C398,298 665,300 740,293",
        "M172,508 C345,505 750,503 882,508",
        "M553,505 C558,611 544,787 329,871",
    ],
    'to-katakana': [
        "M396,112 C403,256 393,631 393,841",
        "M448,377 C551,412 684,508 738,558",
    ],
}
