...
raw_path_strs = {
    'ma-katakana': [
        "M131,346 C250,339 702,321 805,309 C749,405 587,603 478,674",
        "M307,549 C396,597 564,752 617,812",
    ],
    'mi-katakana': [
        "M400,250 C492,265 704,329 772,357",
        "M395,482 C478,496 676,549 743,585",
        "M302,711 C416,715 741,825 813,871",
    ],
    'mu-katakana': [
        "M539,135 C363,675 338,713 211,707 C341,686 747,631 839,615",
        "M715,418 C784,505 877,677 903,750",
    ],
    'me-katakana': [
        "M681,181 C663,387 476,727 178,818",
        "M309,361 C434,403 668,585 741,658",
    ],
    'mo-katakana': [
        "M249,288 C361,286 663,289 772,286",
        "M183,521 C331,522 731,517 889,522",
        "M501,339 C489,869 457,800 837,793",
    ],
}
