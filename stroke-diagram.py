...
raw_path_strs = {
    'sa-katakana': [
        "M115,460 C210,464 813,455 882,460",
        "M336,250 C323,330 331,629 341,683",
        "M647,208 C652,690 635,795 400,878",
    ],
    'shi-katakana': [
        "M266,186 C336,218 411,261 464,304",
        "M178,389 C247,409 320,455 373,499",
        "M240,805 C528,741 752,567 830,380",
    ],
    'su-katakana': [
        "M240,300 C384,295 599,284 693,275 C608,512 402,725 146,812",
        "M555,538 C642,604 784,729 845,800",
    ],
    'se-katakana': [
        "M97,455 C254,430 668,380 782,361 C752,412 656,535 574,597",
        "M336,202 C338,997 272,782 766,814",
    ],
    'so-katakana': [
        "M194,272 C218,304 288,396 322,446",
        "M713,225 C647,670 471,761 261,828",
    ],
}
