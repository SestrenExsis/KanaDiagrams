...
raw_path_strs = {
    'a-katakana': [
        "M133,291 C345,284 620,282 782,275 C740,362 617,503 528,544",
        "M462,416 C475,643 386,809 265,885",
    ],
    'i-katakana': [
        "M153,622 C402,526 633,329 717,172",
        "M540,430 C530,583 540,711 532,882",
    ],
    'u-katakana': [
        "M558,190 C558,247 556,305 556,380",
        "M306,377 C309,446 309,562 302,645",
        "M306,377 C455,373 697,375 857,368 C805,691 736,825 425,891",
    ],
    'e-katakana': [
        "M233,273 C407,279 620,275 781,275",
        "M514,277 C510,405 516,603 510,700",
        "M138,700 C352,699 690,702 882,699",
    ],
    'o-katakana': [
        "M151,409 C366,402 640,410 900,403",
        "M594,197 C592,971 652,919 448,864",
        "M556,414 C443,627 268,763 165,823",
    ],
}
